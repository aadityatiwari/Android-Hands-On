...
public class MyMenu extends ListActivity {
	...
	String[] classes = { "SeekBarVolume", "StatusBar", "TextVoiceActivity",
			"VoiceActivity", "MyGLCubeExample", "MyGLExample",
			"WeatherRelatedActivity", "TwitterRelatedActivity", "HttpExample",
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		String packageName = "com.aadityatiwari.learningandroid.firstproject.";
		try {
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.aboutUs:
			Intent i1 = new Intent(
					"com.aadityatiwari.learningandroid.firstproject.ABOUT");
			startActivity(i1);
			break;
		case R.id.preferences:
			Intent i2 = new Intent(
					"com.aadityatiwari.learningandroid.firstproject.PREFS");
			startActivity(i2);
			break;
		case R.id.exit:
			finish();
